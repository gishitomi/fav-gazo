    ...
    <div id="service">
        ...
        <div class="textbox">
            ...
            <p>
                ...
                この規約は、お客様が、「fav-gazo」サービス（以下「本サービス」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービスをご利用ください。
                ...
                第６条（個人情報等の取り扱い）
                個人情報及び利用者情報については、当社が別途定める「fav-gazoサービスプライバシーポリシー」に則り、適正に取り扱うこととします。
            ...
            <form action="Login.php">
                ...
                <button id="back" type="submit" class="btn-shine">同意して戻る</button>
            </form>
        </div>
